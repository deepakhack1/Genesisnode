...
void input(int head,vector<struct node*> headnodes)
{
    ...
    string name,password,algo='posist';
    int id;
    float value;
...
int main()
{
    ...
    cout<<"1 : Option to create Genesis node that is first node\n";
    cout<<"2 : Option to create set of child nodes of first node\n";
    cout<<"3 : Option to create child node to any set of node\n";
    cout<<"4 : Encrypt data\n";
    cout<<"5 : Verify owner with encryption key\n";
    cout<<"6 : Edit value of a node\n";
    cout<<"7 : Transfer ownership of node\n";
    cout<<"8 : longest chain of genesis node\n";
    cout<<"9 : longest chain of any node\n";
    cout<<"10 : merge two nodes\n";
